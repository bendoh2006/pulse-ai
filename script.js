...
(function () {
  ...
  const i18n = {
    en: {
      ...
      'how.sub': 'Three simple steps stand between a patient and life-saving care.',
      'how.step1.title': 'Enter Symptoms',
      'how.step1.body': 'Patient or caregiver describes symptoms via our web platform or WhatsApp chatbot — available in local languages.',
      'how.step2.title': 'AI Analyzes Severity',
      'how.step2.body': 'Our AI engine processes symptoms, assigns a severity score, and determines the appropriate level of care required.',
      'how.step3.title': 'Smart Routing Recommendation',
      'how.step3.body': 'The platform instantly recommends the best-matched hospital with directions, estimated wait times, and specialist availability.',
    ...
    fr: {
      ...
      'how.sub': 'Trois étapes simples séparent un patient des soins qui sauvent des vies.',
      'how.step1.title': 'Décrire les Symptômes',
      'how.step1.body': 'Le patient ou son aidant décrit ses symptômes via notre plateforme web ou le chatbot WhatsApp — disponible en langues locales.',
      'how.step2.title': 'L\'IA Analyse la Sévérité',
      'how.step2.body': 'Notre moteur IA traite les symptômes, attribue un score de sévérité et détermine le niveau de soins approprié.',
      'how.step3.title': 'Recommandation d\'Orientation',
      'how.step3.body': 'La plateforme recommande instantanément l\'hôpital le mieux adapté avec les directions, les temps d\'attente estimés et la disponibilité des spécialistes.',
